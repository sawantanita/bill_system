...
function AutoSuggestControl(oTextbox /*:HTMLInputElement*/, 
                            oProvider /*:SuggestionProvider*/,oTableName/* table of field*/,oField/*field of value for textbox*/,oquerycondition/* condition of the query*/) {
	//alert("ggggg"+oTextbox+"      "+oProvider+"       "+oTableName+"    "+oField)
	...
	/**
     * The table to select the field for textbox.
     * @scope private
     */
    this.tablename /* table of field*/ = oTableName;
	/**
     * The field for textbox.
     * @scope private
     */
    this.fieldname /*field of value for textbox*/ = oField;
	/**
     * condition of the query.
     * @scope private
     */
    this.qcondition /* condition to be in the query*/ = oquerycondition;		
    /**
...
SuggestionProvider.prototype.requestSuggestions = function (oAutoSuggestControl /*:AutoSuggestControl*/,
    ...
    //define the data
    var oData = { 
	    requesting:  oAutoSuggestControl.tablename,
		requestingField:  oAutoSuggestControl.fieldname,
		requiredCondition:  oAutoSuggestControl.qcondition,
