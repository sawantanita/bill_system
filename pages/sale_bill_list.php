...
$FIELDLIST = "id,prepared_date,purchaser_no,customer_no,product_name,qty,rate,gst_rate,gross_total";    // define feild list
$FIELDNAME = "Id,Date ,Purchaser,Customer,Product,Qty,Rate,GST Rate,Total ";    // Heading Name list
