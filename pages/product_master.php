...
<?php
$TABLENAME = "product_master";                          // define table name
$CHILDTABLENAME = "";  					            // child table name if any
$PKEY = "id";						           // primary key

$FIELDLIST = "id,product_name,product_code,product_gst,prepared_by,prepared_date";		          // table fields 
...
{
	winSel = winOpen("product_list.php","oWin","500","200")
}
function newRecord()
{
...
function saveRecord()
{
	...
	{	
		document.forms[0].action = "product_store.php"
      ...
      <td align="center" valign="top"> <table width="100%" border="0" cellpadding="0">
          <tr> 
            <td height="107"> <table width="500" border="0" align="center">
                <tr class="tablehead"> 
                  <td height="25" colspan="3" align="center"><strong>PRODUCT MASTER</strong> </td>
                </tr>
                <tr height="8"> 
                ...
                <tr> 
                  <td>Product Name</td>
                  <td><div align="center">&nbsp;:&nbsp;</div></td>
                  <td><input type="text"  name="product_name" value="<?=$product_name?>" validate="isNotNull" disName="product_name" onFocus="gonext('btnSave')"> 
                  </td>
                </tr>
				<tr> 
                  <td>Product Code</td>
                  <td><div align="center">&nbsp;:&nbsp;</div></td>
                  <td><input type="text"  name="product_code" value="<?=$product_code?>" validate="isNotNull" disName="product_code" onFocus="gonext('btnSave')"> 
                  </td>
                </tr>
				<tr> 
                  <td>GST RATE</td>
                  <td><div align="center">&nbsp;:&nbsp;</div></td>
                  <td><input type="text"  name="product_gst" value="<?=$product_gst?>" validate="isNotNull" disName="product_gst" onFocus="gonext('btnSave')"> 
                  </td>
                </tr>
